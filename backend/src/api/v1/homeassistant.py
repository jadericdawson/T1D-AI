    ...
    if "pump" in requested_sections:
        ...
        if pump_doc:
            response["pump"] = {
                ...
                "mode_changed_at": pump_doc.get("mode_changed_at"),
                "control_mode": pump_doc.get("control_mode"),
                "control_mode_changed_at": pump_doc.get("control_mode_changed_at"),
                "is_suspended": pump_doc.get("is_suspended", False),
                "last_suspend_reason": pump_doc.get("last_suspend_reason"),
                "last_suspend_at": pump_doc.get("last_suspend_at"),
                ...
                "insulin_remaining": pump_doc.get("insulin_remaining"),
                "last_tubing_fill_at": pump_doc.get("last_tubing_fill_at"),
                "pump_iob": pump_doc.get("pump_iob"),
                "sensor_type": pump_doc.get("sensor_type"),
